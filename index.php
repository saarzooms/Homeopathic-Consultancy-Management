...
<head>
    ...
    <style>
        ...
        .btn-checker {
            ...
            /* background-color: rgba(255, 228, 196, 0.131); */
            margin: 5px;
...
<body style="background-color: #0b6e4f">
    <nav class="navbar shadow navbar-expand-lg fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand me-auto " id="spmsbranding" href="">IDEAL</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-container">
                                <a id="tooltip" class="btn rounded-4 mb-1 mt-1 w-100 edit-button action-button"
                                    href="edit.php" style="background-color: #d1d3ab;"> <span id="tooltiptext">Edit
                                        Patient Details</span> <i class="fa-solid fa-pen-to-square"></i></a>
                                <a id="tooltip" class="btn rounded-4 mb-1 mt-1 w-100 add-button action-button"
                                    href="checkup-page.php" style="background-color: #0b6e4f; color: white;"> <span
